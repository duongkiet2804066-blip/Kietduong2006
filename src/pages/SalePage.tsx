...
const SalePage = ({ onAddToCart }: SalePageProps) => {
  const products = [
    ...
    { id: 406, image: 'https://images.unsplash.com/photo-1520639888713-7851133b1ed0?w=600&q=80', title: 'Premium Leather Boots', originalPrice: '$249.99', price: '$189.99', discount: 24 },
