...
const MenPage = ({ onAddToCart }: MenPageProps) => {
  const products = [
    ...
    { id: 106, image: 'https://images.unsplash.com/photo-1520639888713-7851133b1ed0?w=600&q=80', title: "Men's Leather Boots", price: '$189.99' },
      ...
      <div className="container-lg">
        <div className="row mb-4">
          <div className="col-12">
            <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '36px', fontWeight: 900 }}>Men's Collection</h1>
